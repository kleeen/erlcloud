...
-record(aws_config, {
          ...
          s3_follow_redirect=true::boolean(),
          s3_follow_redirect_count=10::non_neg_integer(),
          %% When set to 'auto' access method is chosen
          %% according to a bucket name:
          %%    * non-DNS-compliant name - 'path'
          %%    * DNS-compliant or empty name - 'vhost'
          ...
          textract_scheme="https://"::string(),
          textract_host="textract.us-east-1.amazonaws.com"::string(),
          textract_port=80::non_neg_integer(),
          textract_retry=fun erlcloud_textract_impl:retry/2::erlcloud_textract_impl:retry_fun(),
          ...
          workspaces_scheme="https://"::string(),
          workspaces_host="workspaces.us-east-1.amazonaws.com"::string(),
          workspaces_port=443::non_neg_integer(),
